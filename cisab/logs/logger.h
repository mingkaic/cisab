...
static cisab::types::StrUMapT<LOG_LEVEL> names2log =
{
	{fatal_level, FATAL},
	...
	{warn_level, WARN},
	{info_level, INFO},
	{debug_level, CISAB_DEBUG},
	{trace_level, TRACE},
};

static cisab::types::StringsT lognames =
{
	fatal_level,
	throw_err_level,
	error_level,
...
{
	trace(::cisab::fmts::sprintf(format, args...));
}
...
{
	debug(::cisab::fmts::sprintf(format, args...));
}
...
{
	info(::cisab::fmts::sprintf(format, args...));
}
...
{
	warn(::cisab::fmts::sprintf(format, args...));
}
...
{
	error(::cisab::fmts::sprintf(format, args...));
}
...
{
	fatal(::cisab::fmts::sprintf(format, args...));
}
